...
uv pip install --python "$VenvName\Scripts\python.exe" python-dotenv aiofiles aiohttp elevenlabs google-genai openai pillow 'tripo3d>=0.4.2' boto3 dashscope 'volcengine-python-sdk[ark]'
