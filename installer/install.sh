...
uv pip install --python "$VENV_NAME/bin/python" python-dotenv aiofiles aiohttp elevenlabs google-genai openai pillow 'tripo3d>=0.4.2' boto3 dashscope 'volcengine-python-sdk[ark]'
